	...
	$.fn.scrollBanner = function(obj){
		...
		$.each(obj.images,function(index,item){
		    if( !!item.href ){
                ...
                $(".scrollBanner-banner").append("<div class='scrollBanner-bannerInner'><img src='"+item.src+"' title='"+item.title+"' /></div>");

            }
		});
        if( !!obj.images[0].href ){
            ...
            $(".scrollBanner-banner").append("<div class='scrollBanner-bannerInner'><img src='" + obj.images[0].src + "' title='" + obj.images[0].title + "' /></div>");
		...
		$(".scrollBanner-bannerInner img").css({
			...
			"position": "relative",
			"left": "50%",
			"margin-left": -parseInt(obj.bannerWidth) / 2 + "px",
		});
